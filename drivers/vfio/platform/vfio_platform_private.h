...
struct vfio_platform_device {
	...
	void	(*of_release)(struct vfio_platform_device *vdev);
...
typedef void (*vfio_platform_release_fn_t)(struct vfio_platform_device *vdev);
...
struct vfio_platform_reset_node {
	...
	vfio_platform_release_fn_t of_release;
	unsigned long irq_flags;
};
