...
static int vfio_iommu_domain_alloc(struct device *dev, void *data)
{
	...
	/*
	 * In systems with multiple IOMMU drivers on the same bus, dev->bus
	 * only records the most recently registered bus ops. Allocate the VFIO
	 * domain from the IOMMU already bound to this device instead.
	 */
	*domain = iommu_domain_alloc_for_dev(dev);
